...
class MeditationPresetsNotifier
  ...
  LocalMeditationPresetsCompanion _presetToCompanion(MeditationPreset p) =>
      LocalMeditationPresetsCompanion(
        ...
        breathingSequenceId: Value(p.breathingSequenceId),
        breathingConfigJson: Value(p.breathingConfigJson),
  ...
  MeditationPreset _presetFromLocal(LocalMeditationPreset r) =>
      MeditationPreset(
        ...
        breathingSequenceId: r.breathingSequenceId,
        breathingConfigJson: r.breathingConfigJson,
